...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 280.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"comment" : "MESSAGE OF MULTIPLES IN",
					"id" : "obj-4",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 18.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 18.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 65.0, 238.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 54.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 180.0, 53.0, 17.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 243.0, 27.0, 20.0 ],
					"style" : "",
					"text" : "ED"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 328.0, 242.0, 53.0, 17.0 ],
					"style" : "",
					"textcolor" : [ 0.848527, 0.909661, 0.909804, 1.0 ],
					"tricolor" : [ 0.239216, 0.254902, 0.278431, 0.425388 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 328.0, 126.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 155.0, 70.0, 20.0 ],
					"style" : "",
					"text" : "multiple list"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 154.0, 83.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 88.0, 31.0, 83.0, 17.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.0, 180.0, 118.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 63.0, 118.0, 17.0 ],
					"style" : "",
					"text" : "2 1 1 3 1 4 1 1 1 1",
					"textcolor" : [ 0.832828, 0.793662, 0.999447, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 153.0, 180.0, 53.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 32.0, 53.0, 17.0 ],
					"style" : "",
					"textcolor" : [ 0.848527, 0.909661, 0.909804, 1.0 ],
					"tricolor" : [ 0.239216, 0.254902, 0.278431, 0.425388 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.0, 169.0, 22.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 30.0, 22.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 65.0, 207.0, 268.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 9.0, 103.0, 17.0 ],
					"style" : "",
					"text" : "groove-rhythm 125",
					"textcolor" : [ 0.747969, 0.77652, 0.784803, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 244.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1.0, 186.0, 82.333328 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
